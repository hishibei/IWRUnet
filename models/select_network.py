...
def define_G(opt):
    ...
    # RDDCNN
    # ----------------------------------------
    elif net_type == 'rddcnn':
        from models.network_dncnn import RDDCNN as net
        netG = net()
    ...
    # ----------------------------------------
        ...
        from models.network_dncnn import RepVGGCNN as net
        netG = net()
    ...
    # ----------------------------------------
        ...
        from models.network_dncnn import ADNet as net
        netG = net(channels = 3)
